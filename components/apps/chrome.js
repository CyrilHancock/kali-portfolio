...
export class Chrome extends Component {
    ...
    displayUrlBar = () => {
        return (
            <div className="w-full pt-0.5 pb-1 flex justify-start items-center text-white text-sm border-b border-gray-900">
                <div onClick={this.refreshChrome} className="flex items-center justify-center ml-2 mr-1 bg-opacity-0 rounded-full  bg-gray-50 hover:bg-opacity-10">
                    <img className="w-5" src="./themes/Yaru/status/chrome_refresh.svg" alt="Ubuntu Chrome Refresh" />
                </div>
                <div onClick={this.goToHome} className="flex items-center justify-center ml-1 mr-2 bg-opacity-0 rounded-full  bg-gray-50 hover:bg-opacity-10">
    ...
    render() {
        return (
            <div className="flex flex-col w-full h-full bg-ub-cool-grey">
                {this.displayUrlBar()}
